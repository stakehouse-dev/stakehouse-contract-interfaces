...
interface IBalanceReporter {
    ...
    /// @param _memberId BLS public key of the KNOT that is part of the house
    ...
    /// @param _memberId KNOT ID i.e. BLS public key of the validator
    function topUpKNOT(bytes calldata _memberId) external payable;
}
